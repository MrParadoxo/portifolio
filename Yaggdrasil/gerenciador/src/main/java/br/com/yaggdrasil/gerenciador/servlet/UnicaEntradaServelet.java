package br.com.yaggdrasil.gerenciador.servlet;
...
import br.com.yaggdrasil.gerenciador.acao.Acao;
...
public class UnicaEntradaServelet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) 
		...
		String nomeDaClasse = "br.com.yaggdrasil.gerenciador.acao." + paramAcao;
		 ...
		 * if(paramAcao.equals("RemovaEmpresa")) { RemovaEmpresa acao = new
		 * RemovaEmpresa(); nome = acao.executa(request, response); }else
		 ...
		 * NovaEmpre-saForm(); nome = acao.executa(request, response); }
		 */
