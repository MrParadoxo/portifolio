...
local function constructNew_frmDataScopeSelectionForm2()
...
function newfrmDataScopeSelectionForm2()
    ...
    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmDataScopeSelectionForm2();
      end,
      function()
...
Firecast.registrarForm(_frmDataScopeSelectionForm2);
