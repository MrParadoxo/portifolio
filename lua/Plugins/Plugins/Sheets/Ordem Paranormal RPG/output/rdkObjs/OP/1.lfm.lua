...
local function constructNew_frmOP1_svg()
...
function newfrmOP1_svg()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmOP1_svg();
      end,
      function()
...
frmOP1_svg = _frmOP1_svg;
Firecast.registrarForm(_frmOP1_svg);
